...
enum class CertType(val value: git_cert_t) {
     ...
     * This may happen when using curl.
     */
    ...
    /**
     * The data argument to the callback will be a pointer to a git_strarray with name:content strings
     * containing information about the certificate.
     * This is used when using curl.
     */
