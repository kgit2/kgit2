...
class CredentialHelperTest {
    ...
    @Test
    fun credentialHelper4() {
        withTempDir {
            val scriptPath = it / "script"
            val scriptFile = FileSystem.SYSTEM.openReadWrite(scriptPath, mustCreate = true, mustExist = false)
